                ...
                <div className="p-6 flex-col">
                    <div className="table w-full mt-3">
                        ...
                        <div className="flex justify-between items-center mb-4">
                            <input onChange={(e) => setSearch(e.target.value)} type="text" placeholder="أبحث باستخدام رقم التذكرة" className=" bg-white border border-gray-300 rounded-md px-4 w-[300px] outline-none py-2" />
                        ...
                        <table className="min-w-full divide-y divide-gray-200 border border-gray-300">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">الاجراءت</th>
                                </tr>
                            </thead>
                                ...
                                {Rvations?.map((reservation, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            ...
                                            }} className="text-blue-600 ml-4 cursor-pointer hover:text-blue-900">
